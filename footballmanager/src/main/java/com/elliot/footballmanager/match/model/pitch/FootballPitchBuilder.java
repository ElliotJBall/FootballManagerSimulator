...
/**
 * Helper class to create and return a new FootballPitch object for use within the MatchEngine.
 *
 * @author Elliot
 */
public class FootballPitchBuilder {
  ...
  private static void addHomeTeamGoal() {
    addPitch(FootballPitchBuilderConstants.homeTeamGoalCoOrdinates,
        new GoalPitch(FootballPitchBuilderConstants.homeTeamGoalCoOrdinates[0],
            FootballPitchBuilderConstants.homeTeamGoalCoOrdinates[1]));
  }

  private static void addAwayTeamGoal() {
    addPitch(FootballPitchBuilderConstants.awayTeamGoalCoOrdinates,
        new GoalPitch(FootballPitchBuilderConstants.awayTeamGoalCoOrdinates[0],
            FootballPitchBuilderConstants.awayTeamGoalCoOrdinates[1]));
  }
