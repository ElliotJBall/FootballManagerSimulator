...
public class FootballPitchPlayerPlacer {
  ...
  private static void addHomeTeamPlayersToPitch() {
    ...
    addTeamGoalkeeperToPitch(homeTeamMatchDaySquad,
        FootballPitchBuilderConstants.ROW_FOR_HOME_TEAM_GOALKEEPER);
    addTeamDefendersToPitch(homeTeamMatchDaySquad,
        FootballPitchBuilderConstants.ROW_FOR_HOME_TEAM_DEFENDERS);
    addTeamMidfieldersToPitch(homeTeamMatchDaySquad,
        FootballPitchBuilderConstants.ROW_FOR_HOME_TEAM_MIDFIELDERS);
    addTeamAttackersToPitch(homeTeamMatchDaySquad,
        FootballPitchBuilderConstants.ROW_FOR_HOME_TEAM_ATTACKERS);

    addOpposingGoalCoordinatesToPlayers(FootballPitchBuilderConstants.awayTeamGoalCoOrdinates,
        alreadyPlacedPlayers);
  }
  ...
  private static void addAwayTeamPlayersToPitch() {
    ...
    addTeamGoalkeeperToPitch(awayTeamMatchDaySquad,
        FootballPitchBuilderConstants.ROW_FOR_AWAY_TEAM_GOALKEEPER);
    addTeamDefendersToPitch(awayTeamMatchDaySquad,
        FootballPitchBuilderConstants.ROW_FOR_AWAY_TEAM_DEFENDERS);
    addTeamMidfieldersToPitch(awayTeamMatchDaySquad,
        FootballPitchBuilderConstants.ROW_FOR_AWAY_TEAM_MIDFIELDERS);
    addTeamAttackersToPitch(awayTeamMatchDaySquad,
        FootballPitchBuilderConstants.ROW_FOR_AWAY_TEAM_ATTACKERS);

    addOpposingGoalCoordinatesToPlayers(FootballPitchBuilderConstants.homeTeamGoalCoOrdinates,
        alreadyPlacedPlayers);
  }

  private static void addTeamGoalkeeperToPitch(MatchDaySquad matchDaySquad,
  ...
  private static void addTeamDefendersToPitch(MatchDaySquad matchDaySquad,
      Integer rowToInsertPlayersInto) {
  ...
  private static List<Player> getPlayersByPosition(MatchDaySquad matchDaySquad,
      Position.GeneralisedPosition requiredGeneralPosition) {
    Player[] startingLineup = matchDaySquad.getStartingLineup();
  ...
  private static int getNumberOfPlayersRequiredForGeneralisedPosition(MatchDaySquad matchDaySquad,
      Position.GeneralisedPosition requiredGeneralPosition) {
  ...
  private static void placePlayersOntoPitch(List<Player> playersToPlace,
      Integer rowToInsertPlayersInto) {
  ...
  private static void addOddNumberOfPlayersToFootballPitch(List<Player> playersToPlace,
      FootballPitch[] rowToInsertInto) {
    ...
    middlePlayer.setBothPreferredAndCurrentYCoordinate(
        FootballPitchBuilderConstants.MIDDLE_OF_A_FOOTBALL_PITCH_ROW);
    rowToInsertInto[FootballPitchBuilderConstants.MIDDLE_OF_A_FOOTBALL_PITCH_ROW]
        .addPlayerToTile(middlePlayer);
  ...
  private static void addEvenNumberOfPlayersToFootballPitch(List<Player> playersToPlace,
      FootballPitch[] rowToInsertInto) {
    // Increments of two so that a empty tile is left between a player
  ...
  private static void addPlayerToGivenFootballRow(List<Player> playersToPlace,
      FootballPitch[] rowToInsertInto, Integer leftSide, Integer rightSide) {
  ...
  private static void addOpposingGoalCoordinatesToPlayers(Integer[] coordinatesOfGoal,
