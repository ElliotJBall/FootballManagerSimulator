...
/**
 * Describes all the possible positions a player can be assigned. Note: A player object can have a
 * primary Position they are proficient in and 0..N secondary positions they can also play.
 *
 * @author Elliot
 */
public enum Position {
  ...
  public static GeneralisedPosition getGeneralPositionBySpecificPosition(Position position) {
    if (generalisedDefenderPositions == null || generalisedMidfielderPositions == null
        || generalisedStrikerPositions == null) {
    ...
    switch (positionAsString) {
      ...
      default:
        throw new IllegalArgumentException(
            "Cannot create Position: " + positionAsString + " Assigning default position (CM).");
    }
  }
