...
public class TechnicalAttributes implements Serializable, PlayerAttribute {
	...
	public TechnicalAttributes(Integer finishing, Integer longShots, Integer penalties, Integer shotPower,
			Integer volleys, Integer crossing, Integer curve, Integer freeKick, Integer longPassing,
			Integer shortPassing, Integer ballControl, Integer dribbling, Integer heading, Integer marking,
